...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ortho_staggered(
        KC_Q,     KC_W,       KC_E,       KC_R,       KC_T,      LM(5,MOD_LGUI),
        KC_A,     KC_S,       KC_D,       KC_F,       KC_G,      LT(3, KC_SPC),
        KC_Z,     KC_X,       KC_C,       KC_V,       KC_B,      LCTL_T(KC_TAB),

        KC_P,     KC_O,       KC_I,       KC_U,       KC_Y,      MT(MOD_LSFT,KC_ENT),
        KC_SCLN,  KC_L,       KC_K,       KC_J,       KC_H,      LT(4, KC_BSPC),
        TD(TD_DOT_COMM),   MO(2),      MO(1),      KC_M,       KC_N,      LGUI_T(KC_ESCAPE)
    ),
    // Sym
    ...
    // Hypr
    [5] = LAYOUT_ortho_staggered(
            ,         ,           ,           ,           ,      LM(5,MOD_LGUI),
            ,         ,           ,           ,           ,                   ,
            ,         ,           ,           ,           ,                    ,

            ,         ,           ,           ,           ,      KC_ENT,
            ,  KC_L,       KC_K,       KC_J,       KC_H,      KC_SPC,
              ,   KC_C,      KC_S,      KC_M,       KC_E,      KC_LSFT
    )
};
